...
public record CourierResponse(Long id, Long userId, String documentId, String fullName,
    ...
    public static CourierResponse from(Courier courier) {
        ...
        return new CourierResponse(courier.getId(), user.getId(), user.getDocumentId(),
