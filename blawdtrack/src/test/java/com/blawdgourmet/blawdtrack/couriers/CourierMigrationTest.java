    ...
    void actualizarDesdeV1ConservaUsuariosYNormalizaEstadoActivo() throws Exception {
        ...
        try (var connection = DriverManager.getConnection(url, "sa", "");
            ...
            statement.executeUpdate("""
                    INSERT INTO usuarios (cedula, nombre_completo, correo, contrasena_hash, estado, rol_id)
                    VALUES ('111', 'Usuario previo activo', 'activo@example.test', 'hash-previo', 'ACTIVO', 1),
            ...
            try (var rows = statement.executeQuery(
                    "SELECT cedula, nombre_completo, correo, contrasena_hash, estado, rol_id FROM usuarios ORDER BY cedula")) {
